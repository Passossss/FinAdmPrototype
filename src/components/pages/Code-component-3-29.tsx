...
import { TrendingUp, TrendingDown, DollarSign, CreditCard, Target, PiggyBank, ArrowUpRight, ArrowDownRight, Plus } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1>Olá, Gustavo! 👋</h1>
          <p className="text-muted-foreground">Aqui está um resumo das suas finanças hoje</p>
        </div>
